...
<body class="bg-gradient-primary">
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" style="align-content: center; background: black;">
                                <img src="./img/tobe/CI_b.jfif" style="width: 100%;" />
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">통합 결재 시스템</h1>
                                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (errorDiv) {
                // 페이지 로드 시 error 파라미터가 있으면 표시, 없으면 숨김
                errorDiv.style.display = hasError ? 'block' : 'none';
                
                // URL에서 error 파라미터 제거 (히스토리는 유지)
                if (hasError) {
